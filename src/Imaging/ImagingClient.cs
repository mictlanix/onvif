...
namespace Mictlanix.DotNet.Onvif.Imaging
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.onvif.org/ver20/imaging/wsdl", ConfigurationName="Mictlanix.DotNet.Onvif.Imaging.Imaging")]
    public interface Imaging
    {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<Mictlanix.DotNet.Onvif.Imaging.GetPresetsResponse> GetPresetsAsync(Mictlanix.DotNet.Onvif.Imaging.GetPresetsRequest request);
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("dotnet-svcutil", "1.0.3")]
    public partial class ImagingClient : System.ServiceModel.ClientBase<Mictlanix.DotNet.Onvif.Imaging.Imaging>, Mictlanix.DotNet.Onvif.Imaging.Imaging
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Mictlanix.DotNet.Onvif.Imaging.GetPresetsResponse> Mictlanix.DotNet.Onvif.Imaging.Imaging.GetPresetsAsync(Mictlanix.DotNet.Onvif.Imaging.GetPresetsRequest request)
        {
            return base.Channel.GetPresetsAsync(request);
        }
        
        public System.Threading.Tasks.Task<Mictlanix.DotNet.Onvif.Imaging.GetPresetsResponse> GetPresetsAsync(string VideoSourceToken)
        {
            Mictlanix.DotNet.Onvif.Imaging.GetPresetsRequest inValue = new Mictlanix.DotNet.Onvif.Imaging.GetPresetsRequest();
